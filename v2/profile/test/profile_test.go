...
import (
	...
	"github.com/TwilgateLabs/inhive-core/v2/profile"
	"github.com/sagernet/sing-box/experimental/libbox"
)

func TestAddByContent(t *testing.T) {
	ctx := libbox.BaseContext(nil)
	entity, err := profile.AddByUrl(ctx, "https://raw.githubusercontent.com/TwilgateLabs/inhive-core/refs/heads/main/test.configs/warp", "", false)
	if err != nil {
